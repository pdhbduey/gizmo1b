    ...
    LibTask(name)
{
    ...
    m_boardTestMap[BoardTest::TEC_DAC_OFFSET]             = boardTest;
    m_boardTestMap[BoardTest::TEC_PROPORTIONAL_GAIN] = boardTest;
    m_boardTestMap[BoardTest::TEC_INTEGRAL_GAIN]     = boardTest;
    m_boardTestMap[BoardTest::TEC_DERIVATIVE_GAIN]   = boardTest;

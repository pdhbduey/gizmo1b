...
struct LibThermistorCurves::Conversion* LibThermistorCurves::s_types[] = {
    [USP12837]        = s_convTableUSP12837,
    [SC30F103AN]      = s_convTableSC30F103AN,
    [NTCG163JF103FT1] = s_convTableSC30F103AN,
};
struct LibThermistorCurves::Conversion LibThermistorCurves::s_convTableUSP12837[] = {
...
struct LibThermistorCurves::Conversion LibThermistorCurves::s_convTableSC30F103AN[] = {
...
struct LibThermistorCurves::Conversion LibThermistorCurves::s_convTableNTCG163JF103FT1[] = {
...
float LibThermistorCurves::getTemperature(float rt)
{
...
int LibThermistorCurves::setType(int type)
{
    LibMutex libMutex(m_mutex);
    switch (type) {
    default:
...
int LibThermistorCurves::getType()
{
    return m_type;
}

int LibThermistorCurves::setUnits(int units)
{
    LibMutex libMutex(m_mutex);
    switch (units) {
    default:
...
int LibThermistorCurves::getUnits()
{
    return m_units;
}
